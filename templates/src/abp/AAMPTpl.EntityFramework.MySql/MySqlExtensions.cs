...
namespace AAMPTpl.EntityFramework.MySql
{
    /// <summary>
    /// 数据库扩展
    /// </summary>
    public static class MySqlExtensions
    {
            ...
            where TDbContext : AbpDbContext<TDbContext>
        {
            ...
            options.Configure<TDbContext>(ctx =>
            {
                ...
                {
                    ctx.DbContextOptions.UseMySQL(ctx.ExistingConnection, optionsAction);
                }
                else
                {
                    ctx.DbContextOptions.UseMySQL(connectionString, optionsAction);
                }
            });
        }
    }
