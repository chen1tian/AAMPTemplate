...
public partial class MainViewModel : ViewModelBase
{
    ...
    [ObservableProperty]
    private bool _navDrawerSwitch = true;

    partial void OnNavDrawerSwitchChanged(bool value)
    {
        OnPropertyChanged(nameof(IsMenuTextVisible));
        OnPropertyChanged(nameof(ToggleMenuIcon));
    }

    public bool IsMenuTextVisible => NavDrawerSwitch;

    public string ToggleMenuIcon => NavDrawerSwitch
        ? "M15.41,16.58L10.83,12L15.41,7.41L14,6L8,12L14,18L15.41,16.58Z"
        : "M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z";

    public string CurrentPageTitle => SelectedMenuItem.Title;
